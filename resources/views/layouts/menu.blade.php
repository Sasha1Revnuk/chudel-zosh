            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item  dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li class="nav-item {{Route::currentRouteName() == 'attestation' ? 'active' : ''}}"><a href="/attestation" {!!   '/' . request()->route()->uri == '/attestation' ? 'style="color: #218a39; font-size: 15px;"' : 'style="color: #000; font-size: 15px;"' !!} class="nav-link">Атестація</a></li>
                        ...
                        <li class="nav-item {{Route::currentRouteName() == 'civil-save' ? 'active' : ''}}"><a href="/civil-save" {!! '/' . request()->route()->uri == '/psychological-service' ? 'style="color: #218a39; font-size: 15px;"' : 'style="color: #000; font-size: 15px;"'!!} class="nav-link">Цивільний захист</a></li>
                        <li class="nav-item {{Route::currentRouteName() == '/normy' ? 'active' : ''}}"><a href="/normy-save" {!! '/' . request()->route()->uri == '/normy' ? 'style="color: #218a39; font-size: 15px;"' : 'style="color: #000; font-size: 15px;"'!!} class="nav-link">Документи</a></li>
                    </ul>
                </li>
                <li class="nav-item  dropdown">
                    ...
                    <ul class="dropdown-menu">
                            ...
                            <li class="nav-item {{Route::currentRouteName() == 'educational-activities' ? 'active' : ''}}">
                                <a class="nav-link" href="/methodical-work"   {!! '/' . request()->route()->uri == '/educational-activities' ? 'style="color: #218a39; font-size: 15px;"' : 'style="color: #000; font-size: 15px;"' !!} style="color: #000; font-size: 15px;">Виховна робота</a>
                            </li>
                            <li class="nav-item {{Route::currentRouteName() == 'educational-work' ? 'active' : ''}}">
                                <a class="nav-link" href="/methodical-work"   {!! '/' . request()->route()->uri == '/educational-work' ? 'style="color: #218a39; font-size: 15px;"' : 'style="color: #000; font-size: 15px;"' !!} style="color: #000; font-size: 15px;">Навчальна робота</a>
                            </li>
                            <li class="nav-item {{Route::currentRouteName() == 'inclusive-education' ? 'active' : ''}}">
                                <a class="nav-link" href="/methodical-work"   {!! '/' . request()->route()->uri == '/inclusive-education' ? 'style="color: #218a39; font-size: 15px;"' : 'style="color: #000; font-size: 15px;"' !!} style="color: #000; font-size: 15px;">Інклюзивне навчнання</a>
                            </li>
                            <li class="nav-item {{Route::currentRouteName() == 'professional-training-and-career-guidance' ? 'active' : ''}}">
                                <a class="nav-link" href="/methodical-work"   {!! '/' . request()->route()->uri == '/professional-training-and-career-guidance' ? 'style="color: #218a39; font-size: 15px;"' : 'style="color: #000; font-size: 15px;"' !!} style="color: #000; font-size: 15px;">Профільне навчання та профорієнтація</a>
                            </li>
                ...
                <li class="nav-item {{Route::currentRouteName() == 'for-parents' ? 'active' : ''}}"><a href="/for-parants" class="nav-link">Батькам</a></li>
