            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item  dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="nav-item {{Route::currentRouteName() == 'library' ? 'active' : ''}}"><a href="/library" {!! '/' . request()->route()->uri == '/library' ? 'style="color: #218a39; font-size: 15px;"' : 'style="color: #000; font-size: 15px;"' !!} class="nav-link">Шкільна бібліотека</a></li>
